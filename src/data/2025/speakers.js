...
export const SpeakersData = [
  ...
  },
  {
    ...
    session: {
      ...
      description: `This session highlights how IBM watsonx and agentic AI architectures can streamline complex HR operations by unifying workflows across disparate enterprise systems. Using a simplified AskHR agent built with watsonx Orchestrate, we demonstrate how reasoning-enabled agents interact with tools, APIs, and knowledge sources to perform tasks such as querying employee data, submitting time-off requests, and updating records.\n\nWe will walk through the technical architecture behind the agent—including multi-agent orchestration, OpenAPI-based connectors, secure data retrieval, and built-in grounding to minimize hallucinations. The lab showcases how developers can rapidly integrate existing HR platforms like Workday or SuccessFactors, or create custom tools for any internal system.\n\nAttendees will leave with a practical understanding of how to build, configure, and extend agentic workflows on watsonx to automate real-world operational processes at scale.`,
      tags: [],
      track: 'Hackathon',
      time: '11:00',
  ...
  },
  {
    ...
    session: {
      ...
      description: `In this high-impact lightning talk, Professor Timothy E. Bates—known as The Godfather of Tech—breaks down why small-scale AI models are the most powerful tool in a solo developer’s arsenal. Aimed at builders, coders, creators, and engineers working on internal apps, dashboards, and game engines like Unity or Unreal, this session demystifies the capabilities of 1B–7B parameter models like Mistral 7B and Phi-2—and shows how they rival giants, without the cloud.\n\nFrom Detroit to global dev rooms, Prof B explains how edge AI is democratizing innovation, enabling localized, private, and high-speed deployments for solo makers and indie teams. You'll leave with a blueprint for how to deploy, fine-tune, and quantize small LLMs, all while aligning with ethical and efficient AI development practices.\n\nWhether you're coding in a coffee shop or managing AI ops for a small business, this talk equips you with the mindset and tools to build lean, lethal, and local.`,
      tags: [],
      track: 'Hackathon',
      time: '13:00',
      room: 'STEM Innovation Learning Center (SILC) - 7th Floor',
